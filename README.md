...
**Deep Learning for short-term precipitation forecasting (0-30min) using real MeteoSwiss RZC radar data.** [web:71]

## 🎯 Project Status

| Milestone | Status | Description |
|-----------|--------|-------------|
| **1. Data Pipeline** | ✅ Complete | MCH RZC data → PyTorch Dataset with sequences [web:71] |
...
| **4. Multi-Step + CSI** | ⏳ Planned | 3/6-step predictions + weather metrics [web:49] |
